...
def val(args, val_loader, model, epoch):
    ...
    for iter, batched_inputs in enumerate(val_loader):
        ...
        map[index_fn] = [0, 0, 255]  # blue

        change_map = Image.fromarray(np.array(map, dtype=np.uint8))

        change_map.save(args.vis_dir + img_name)
        cam_out_name = "/media/yang/1305D8BDB8D46DEE/zzz/A2Net-main/vis_out_cam" + img_name
        cam_output_name = "/media/yang/1305D8BDB8D46DEE/zzz/A2Net-main/vis_output_cam" + img_name
        #
        ...
        #     vis = np.clip(vis_pred, a_min=0.0, a_max=1.0)
...
def ValidateSegmentation(args):
    ...
    args.vis_dir = './4_3_withoutLBA_UAV/' + args.file_root + '/'

    if args.file_root == 'LEVIR':
        args.file_root = '/media/WD_2T/ZYJ/315_cd_data/LEVIR_256/256'
    elif args.file_root == 'UAV':
        args.file_root = '/media/WD_1T/cd/UAV-CD_256'
    elif args.file_root == 'CDD':
        args.file_root = '/media/yang/1305D8BDB8D46DEE/zzz/cd/zyj_cd/CDD_256'
    elif args.file_root == 'S2Looking':
        args.file_root = '/media/WD_1T/cd/S2Looking-CD256'
    elif args.file_root == 'WUH':
        args.file_root = '/media/yang/1305D8BDB8D46DEE/data/cd/WHU-CD-256(Paper)'
    elif args.file_root == 'SYSU':
        args.file_root = '/media/WD_2T/ZYJ/315_cd_data/SYSU-CD'
    elif args.file_root == 'temp':
        args.file_root = '/media/WD_1T/cd/temp'
    ...
    # load the model
    model_file_name = '/media/WD_2T/ZYJ/zyj_shiyan/A2Net-main/7_25_resnet34消融_UAV_iter_40000_lr_0.0005/best_model.pth'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_root', default="UAV", help='Data directory | LEVIR | S2Looking | SYSU ')
