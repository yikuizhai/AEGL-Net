...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_root', default="LEVIR", help='Data directory | LEVIR | BCDD | SYSU | UAV | CDD | WUH |S2Looking | CLCD | UAV-BCD |')
    ...
    parser.add_argument('--savedir', default='./8_19_1333', help='Directory to save the results')
